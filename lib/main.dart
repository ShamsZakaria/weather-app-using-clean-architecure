...
import 'package:weather_app_with_clean_architecure/weather_app/data/repository/weather_repository.dart';
...
import 'package:weather_app_with_clean_architecure/weather_app/domain/usescase/get_weather_by_country_name.dart';
...
void main() async {
  ...
  Weather weather =
      await GetWeatherByCountryName(baseWeatherRepository).excute("Egypt");
  print(weather);
  runApp(const MyApp());
}
